  ...
  auto loopBuilder = [&]() {
    ...
    builder.createFor(
        ...
        [&](mlir::OpBuilder &b, mlir::Location loc) {
          ...
          auto loadCur = cir::LoadOp::create(
              builder, loc, mlir::ValueRange{itr}, cir::LoadOp::Properties{});
        ...
        [&](mlir::OpBuilder &b, mlir::Location loc) {
          ...
          auto load = cir::LoadOp::create(builder, loc, mlir::ValueRange{itr},
...
std::pair<mlir::Value, mlir::Value> OpenACCRecipeBuilderBase::createBoundsLoop(
  ...
  auto doSubscriptOp = [&](mlir::Value subVal,
    ...
    auto eltLoad = cir::LoadOp::create(builder, loc, mlir::ValueRange{subVal},
                                       cir::LoadOp::Properties{});
...
void OpenACCRecipeBuilderBase::createReductionRecipeCombiner(
  ...
  if (const auto *cat = cgf.getContext().getAsConstantArrayType(origType)) {
    ...
    builder.setInsertionPointAfter(builder.createFor(
        ...
        /*condBuilder=*/
        [&](mlir::OpBuilder &b, mlir::Location loc) {
          auto loadItr = cir::LoadOp::create(
              builder, loc, mlir::ValueRange{itr}, cir::LoadOp::Properties{});
