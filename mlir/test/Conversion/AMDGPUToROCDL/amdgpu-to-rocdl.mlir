...
func.func @gpu_gcn_raw_buffer_load_scalar_i32(%buf: memref<i32>) -> i32 {
  ...
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[] : memref<i32> -> i32
  func.return %0 : i32
}
...
func.func @gpu_gcn_raw_buffer_load_i32(%buf: memref<64xi32>, %idx: i32) -> i32 {
  ...
  // CHECK: %[[ret:.*]] = rocdl.raw.ptr.buffer.load %[[resource]], %{{.*}}, %{{.*}}, 0 : i32
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xi32>, i32 -> i32
  func.return %0 : i32
}
...
func.func @gpu_gcn_raw_buffer_load_i32_strided(%buf: memref<16x16xi32, strided<[?, ?], offset: ?>>, %i: i32, %j: i32) -> i32 {
    ...
    // CHECK: return %[[v]] : i32
  %0 = amdgpu.raw_buffer_load  %buf[%i, %j] :  memref<16x16xi32, strided<[?, ?], offset: ?>>, i32, i32 -> i32
  func.return %0 : i32
}
...
func.func @gpu_gcn_raw_buffer_load_1xi32(%buf: memref<64xi32>, %idx: i32) -> vector<1xi32> {
  ...
  // CHECK: return %[[cast]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xi32>, i32 -> vector<1xi32>
...
func.func @gpu_gcn_raw_buffer_load_2xi32(%buf: memref<64xi32>, %idx: i32) -> vector<2xi32> {
  ...
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xi32>, i32 -> vector<2xi32>
...
func.func @gpu_gcn_raw_buffer_load_i8(%buf: memref<64xi8>, %idx: i32) -> i8 {
  ...
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xi8>, i32 -> i8
  func.return %0 : i8
}
...
func.func @gpu_gcn_raw_buffer_load_2xi8(%buf: memref<64xi8>, %idx: i32) -> vector<2xi8> {
  ...
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xi8>, i32 -> vector<2xi8>
...
func.func @gpu_gcn_raw_buffer_load_16xi8(%buf: memref<64xi8>, %idx: i32) -> vector<16xi8> {
  ...
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xi8>, i32 -> vector<16xi8>
...
func.func @gpu_gcn_raw_buffer_load_f8E5M2FNUZ(%buf: memref<64xf8E5M2FNUZ>, %idx: i32) -> f8E5M2FNUZ {
  ...
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xf8E5M2FNUZ>, i32 -> f8E5M2FNUZ
...
func.func @gpu_gcn_raw_buffer_load_4xf8E4M3FNUZ(%buf: memref<64xf8E4M3FNUZ>, %idx: i32) -> vector<4xf8E4M3FNUZ> {
  ...
  // CHECK: return %[[ret]]
  %0 = amdgpu.raw_buffer_load  %buf[%idx] : memref<64xf8E4M3FNUZ>, i32 -> vector<4xf8E4M3FNUZ>
...
func.func @amdgpu_raw_buffer_atomic_cmpswap_f32(%src : f32, %cmp : f32, %buf : memref<64xf32>, %idx: i32) -> f32 {
  ...
  %dst = amdgpu.raw_buffer_atomic_cmpswap  %src, %cmp -> %buf[%idx] : f32 -> memref<64xf32>, i32
  func.return %dst : f32
}
...
func.func @amdgpu_raw_buffer_atomic_cmpswap_i64(%src : i64, %cmp : i64, %buf : memref<64xi64>, %idx: i32) -> i64 {
  ...
  // CHECK: return %[[dst]]
  %dst = amdgpu.raw_buffer_atomic_cmpswap  %src, %cmp -> %buf[%idx] : i64 -> memref<64xi64>, i32
  func.return %dst : i64
}
...
func.func @amdgpu_raw_buffer_atomic_cmpswap_v2f16(%src : vector<2xf16>, %cmp : vector<2xf16>, %buf : memref<64xf16>, %idx: i32) -> vector<2xf16> {
  ...
  // CHECK: return %[[dst]]
  %dst = amdgpu.raw_buffer_atomic_cmpswap  %src, %cmp -> %buf[%idx] : vector<2xf16> -> memref<64xf16>, i32
