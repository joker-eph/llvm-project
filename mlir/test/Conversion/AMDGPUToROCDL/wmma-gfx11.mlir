...
func.func @wmma_to_rocdl(%arg0 : vector<16xf16>, %arg1 : vector<8xf32>, %arg2 : vector<4xf32>,
  ...
  // CHECK: rocdl.wmma.i32.16x16x16.iu8{{.*}} signA = true signB = true clamp = true : (vector<4xi32>, vector<4xi32>, vector<8xi32>) -> vector<8xi32>
  ...
  // CHECK: rocdl.wmma.i32.16x16x16.iu4{{.*}} signA = true signB = true clamp = true : (vector<2xi32>, vector<2xi32>, vector<8xi32>) -> vector<8xi32>
