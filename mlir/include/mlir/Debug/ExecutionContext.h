...
public:
  ...
  void setCallback(CallbackTy callback, bool passThrough = false) {
...
private:
  ...
  /// This flag is used to indicate that should always invoke the callback
  /// regardless if a breakpoint is hit.
